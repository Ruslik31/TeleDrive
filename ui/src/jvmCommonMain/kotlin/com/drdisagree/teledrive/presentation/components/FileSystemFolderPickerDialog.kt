        ...
        text = {
            Column {
                ...
                Row(
                    ...
                    FilterChip(
                        selected = currentPath == "/storage/emulated/0/Documents",
                        onClick = { loadPath("/storage/emulated/0/Documents") },
                    ...
                    FilterChip(
                        selected = currentPath == "/storage/emulated/0/DCIM",
                        onClick = { loadPath("/storage/emulated/0/DCIM") },
                        label = { Text("DCIM") },
                        leadingIcon = {
                            Icon(Icons.Filled.Folder, contentDescription = null, modifier = Modifier.size(16.dp))
                        }
                    ...
                    FilterChip(
                        selected = currentPath == "/storage/emulated/0/Pictures",
                        onClick = { loadPath("/storage/emulated/0/Pictures") },
                        label = { Text("Pictures") },
                        leadingIcon = {
                            Icon(Icons.Filled.Folder, contentDescription = null, modifier = Modifier.size(16.dp))
                        }
